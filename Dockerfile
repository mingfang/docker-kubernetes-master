...
#Etcd
RUN wget -O - https://github.com/coreos/etcd/releases/download/v2.1.3/etcd-v2.1.3-linux-amd64.tar.gz | tar zx
RUN mv /etcd* /etcd && \
...
#Kubernetes
RUN wget -O - https://github.com/kubernetes/kubernetes/releases/download/v1.1.1/kubernetes.tar.gz | tar zx
